...
class BonfireSurfaceView @JvmOverloads constructor(
    context: Context,
    ...
    class DrawThread(private val surfaceHolder: SurfaceHolder) : Thread() {
        ...
        private fun spawnParticles() {
            if (weather == "Rainy") {
                if (random.nextFloat() < 0.5) return // 50% 확률로 파티클 생성 스킵
            }
            ...
            for (i in 0 until count) {
                ...
                particles.add(Particle(
                    ...
                    color = particleColor, // 4. 방금 계산한 '개별 색상'을 할당합니다.
                    type = "fire"
                ))
            }
