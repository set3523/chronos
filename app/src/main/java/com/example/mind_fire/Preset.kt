                            ...
                            Row(
                                ...
                                IconButton(onClick = {
                                    ...
                                    if (currentPresets.remove(presetName)) {
                                        ...
                                        editor.remove("preset_${presetName}_temperature")
                                        editor.remove("preset_${presetName}_intensity")
                                        editor.remove("preset_${presetName}_windSpeed")
                                        editor.remove("preset_${presetName}_logSize")
                                        editor.remove("preset_${presetName}_environment")
                                        editor.remove("preset_${presetName}_weather")
                                        editor.apply()
