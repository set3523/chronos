...
class WidgetAnimationService : Service() {
    ...
    private fun startForegroundService() {
        ...
        val notification: Notification = NotificationCompat.Builder(this, channelId)
            .setContentTitle("Bonfire Widget")
    ...
    private fun updateAndDraw() {
        ...
        val componentName = ComponentName(context, BonfireWidgetProvider::class.java)
        val appWidgetIds = appWidgetManager.getAppWidgetIds(componentName)

        if (appWidgetIds.isNotEmpty()) {
            val views = RemoteViews(packageName, R.layout.widget_bonfire)
